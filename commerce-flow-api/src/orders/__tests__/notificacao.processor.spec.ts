...
describe('NotificacaoProcessor', () => {
  let processor: NotificacaoProcessor;
  let queue;
  ...
  beforeEach(async () => {
    ...
    processor = module.get<NotificacaoProcessor>(NotificacaoProcessor);
    queue = module.get(getQueueToken('notificacao'));
  });
  ...
  describe('handleNotificacao', () => {
    it('should handle notificacao job', async () => {
      ...
      const result = await processor.handleNotificacao(mockJob as any);
  ...
  describe('event handlers', () => {
    it('should log on job completed', () => {
      ...
      processor.onCompleted(mockJob as any);
    ...
    it('should log on job failed', () => {
      ...
      processor.onFailed(mockJob as any, mockErr);
